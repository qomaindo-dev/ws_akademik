...
class Ruang_model extends CI_Model {
	...
	var $table = 'kelas';
	var $column_order = array('kelas','jml_siswa',null); //set column field database for datatable orderable
	var $column_search = array('kelas'); //set column field database for datatable searchable just firstname , lastname , address are searchable
