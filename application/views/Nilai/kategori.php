<div class="content-wrapper">
    ...
    <div class="container">
        <div class="col-md-12">
        <h1 style="font-size:20pt">Kategori Nilai</h1>
...
function edit_kategori(id_kategori)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="kategori_nilai"]').val(data.kategori_nilai);
            $('[name="bobot"]').val(data.bobot);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Kategori Nilai'); // Set title to Bootstrap modal title
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Kategori Nilai</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Kategori Nilai</label>
                            <div class="col-md-9">
                                <input name="kategori_nilai" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="bobot"  class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
