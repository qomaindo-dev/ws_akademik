<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <br />
        <button class="btn btn-success" onclick="add_ruang()"><i class="fa fa-plus"></i> Tambah Kelas</button>
...
function edit_ruang(id_kelas)
{
    ...
    $.ajax({
        url : "<?php echo site_url('ruang/ajax_edit/')?>/" + id_kelas,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="jml_siswa"]').val(data.jml_siswa);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('ruang/ajax_add')?>";
    } else {
        url = "<?php echo site_url('ruang/ajax_update')?>";
    }
...
function delete_ruang(id_kelas)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('ruang/ajax_delete')?>/"+id_kelas,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
