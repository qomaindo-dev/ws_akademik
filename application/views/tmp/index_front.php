				...
				<div class="primary-header">
					<div class="container">
						...
						<div class="main-navigation">
							...
							<ul class="menu">
								<li class="menu-item "><a href="<?php echo base_url()?>page_siswa/Halamansiswa">Home</a></li>
							...
							<ul class="slides">
								<li>
									<div class="slide-caption">
										<h2 class="slide-title"><br> Selamat Datang Kembali Ke Sekolah!</h2>
										<p> Selamat Datang di Website Sekolah Menengah Pertama </p>
										
									</div>
									<br>
									<img width="400px" height="400px" src="<?php echo base_url('assets/front/img/icon.png');?>" alt="">
